...
#'
#' LPI identification based on fragmentation patterns for LC-MS/MS
...
#' here.
#'
#' @return List with LPI annotations (results) and some additional information
...
#'
#' @examples
#' idLPIneg(MS1 = LipidMS::mix_neg_fullMS, MSMS1 = LipidMS::mix_neg_Ce20,
#' MSMS2 = LipidMS::mix_neg_Ce40)
#'
#' idLPIneg(MS1 = LipidMS::serum_neg_fullMS, MSMS1 = LipidMS::serum_neg_Ce20,
#' MSMS2 = LipidMS::serum_neg_Ce40)
#'
#' @author M Isabel Alcoriza-Balaguer <maialba@alumni.uv.es>
idLPIneg <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
                     ...
                     dbs = list(lysopidb = LipidMS::lysopidb,
                                fadb = LipidMS::fadb,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["lysopidb"]], ppm_precursor, rt,
                               adducts, rttol, dbs)
