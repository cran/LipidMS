...
#' 78.9585 and 96.969. 3) Search of specific fragments that confirm chain
#' composition (neutral loss of 1 H2O molecule).
#'
...
#'
#' @examples
#' idSphPneg(MS1 = LipidMS::mix_neg_fullMS, MSMS1 = LipidMS::mix_neg_Ce20,
#' MSMS2 = LipidMS::mix_neg_Ce40)
#'
#' idSphPneg(MS1 = LipidMS::serum_neg_fullMS, MSMS1 = LipidMS::serum_neg_Ce20,
#' MSMS2 = LipidMS::serum_neg_Ce40)
#'
#' @author M Isabel Alcoriza-Balaguer <maialba@alumni.uv.es>
idSphPneg <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
