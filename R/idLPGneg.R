...
#'
#' LPG identification based on fragmentation patterns for LC-MS/MS
...
#' here.
#'
#' @return List with LPG annotations (results) and some additional information
...
#'
#' @examples
#' idLPGneg(MS1 = LipidMS::mix_neg_fullMS, MSMS1 = LipidMS::mix_neg_Ce20,
#' MSMS2 = LipidMS::mix_neg_Ce40)
#'
#' idLPGneg(MS1 = LipidMS::serum_neg_fullMS, MSMS1 = LipidMS::serum_neg_Ce20,
#' MSMS2 = LipidMS::serum_neg_Ce40)
#'
#' @author M Isabel Alcoriza-Balaguer <maialba@alumni.uv.es>
idLPGneg <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
                     ...
                     dbs = list(lysopgdb = LipidMS::lysopgdb,
                                fadb = LipidMS::fadb,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["lysopgdb"]], ppm_precursor, rt,
                               adducts, rttol, dbs)
