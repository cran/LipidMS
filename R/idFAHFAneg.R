...
#'
#' FAHFA identification based on fragmentation patterns for LC-MS/MS
...
#' here.
#'
#' @return list with FAHFA annotations (results) and some additional information
...
#'
#' @examples
#' idFAHFAneg(MS1 = LipidMS::mix_neg_fullMS, MSMS1 = LipidMS::mix_neg_Ce20,
#' MSMS2 = LipidMS::mix_neg_Ce40)
#'
#' idFAHFAneg(MS1 = LipidMS::serum_neg_fullMS, MSMS1 = LipidMS::serum_neg_Ce20,
#' MSMS2 = LipidMS::serum_neg_Ce40)
#'
#' @author M Isabel Alcoriza-Balaguer <maialba@alumni.uv.es>
idFAHFAneg <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
                       ...
                       rates = c("3/1"),
                       intrequired = c(T),
                       dbs = list(fahfadb = LipidMS::fahfadb,
                                  hfadb = LipidMS::hfadb,
                                  fadb = LipidMS::fadb,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["fahfadb"]], ppm_precursor, rt, adducts,
                               rttol, dbs)
