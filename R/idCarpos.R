...
#'
#' Carnitines identification based on fragmentation patterns for LC-MS/MS
...
#'
#' @return list with Carnitine annotations (results) and some additional
#' information (class fragments and chain fragments).
#'
...
idCarpos <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
                     ...
                     dbs = list(carnitinesdb = LipidMS::carnitinesdb,
                                fadb = LipidMS::fadb,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["carnitinesdb"]], ppm_precursor, rt,
                               adducts, rttol, dbs)
