...
#'
#' @examples
#' idCerneg(MS1 = LipidMS::mix_neg_fullMS, MSMS1 = LipidMS::mix_neg_Ce20,
#' MSMS2 = LipidMS::mix_neg_Ce40)
#'
#' idCerneg(MS1 = LipidMS::serum_neg_fullMS, MSMS1 = LipidMS::serum_neg_Ce20,
#' MSMS2 = LipidMS::serum_neg_Ce40)
#'
#' @author M Isabel Alcoriza-Balaguer <maialba@alumni.uv.es>
idCerneg <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
                     ...
                     clrequired = c(),
                     ftype = c(),
                     chainfrags_sn1 = c("NL-nlsph_M-H", "sph_M-H-2H2O"),
                     chainfrags_sn2 = c("fa_Mn-1.9918"),
                     intrules = c(),
                     rates = c(),
                     intrequired = c(),
                     dbs = list(cerdb = LipidMS::cerdb,
                                nlsphdb = LipidMS::nlsphdb,
                                sphdb = LipidMS::sphdb,
                                fadb = LipidMS::fadb,
