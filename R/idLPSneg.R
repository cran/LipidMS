...
#'
#' @examples
#' idLPSneg(MS1 = LipidMS::mix_neg_fullMS, MSMS1 = LipidMS::mix_neg_Ce20,
#' MSMS2 = LipidMS::mix_neg_Ce40)
#'
#' idLPSneg(MS1 = LipidMS::serum_neg_fullMS, MSMS1 = LipidMS::serum_neg_Ce20,
#' MSMS2 = LipidMS::serum_neg_Ce40)
#'
#' @author M Isabel Alcoriza-Balaguer <maialba@alumni.uv.es>
idLPSneg <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
                     ...
                     dbs = list(lysopsdb = LipidMS::lysopsdb,
                                fadb = LipidMS::fadb,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["lysopsdb"]], ppm_precursor, rt,
                               adducts, rttol, dbs)
