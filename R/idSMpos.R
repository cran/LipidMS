...
#'
#' SM identification based on fragmentation patterns for LC-MS/MS
...
#' here.
#'
#' @return List with SM annotations (results) and some additional information
...
idSMpos <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["smdb"]], ppm_precursor, rt, adducts,
                               rttol, dbs)
