...
#' here.
#'
#' @return List with LPE annotations (results) and some additional information
...
#'
#' @examples
#' idLPEpos(MS1 = LipidMS::mix_pos_fullMS, MSMS1 = LipidMS::mix_pos_Ce20,
#' MSMS2 = LipidMS::mix_pos_Ce40)
#'
#' idLPEpos(MS1 = LipidMS::serum_pos_fullMS, MSMS1 = LipidMS::serum_pos_Ce20,
#' MSMS2 = LipidMS::serum_pos_Ce40)
#'
#' @author M Isabel Alcoriza-Balaguer <maialba@alumni.uv.es>
idLPEpos <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["lysopedb"]], ppm_precursor, rt,
                               adducts, rttol, dbs)
