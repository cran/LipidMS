...
idPIneg <- function(MS1, MSMS1, MSMS2 = data.frame(), ppm_precursor = 5,
                    ...
                    intrules = c("lysopi_sn1/lysopi_sn1",
                                 "lysopa_sn1/lysopa_sn1"),
                    rates = c("3/1", "3/1"),
                    intrequired = c(F, F),
                    dbs = list(pidb = LipidMS::pidb,
                               lysopidb = LipidMS::lysopidb,
  ...
  # candidates search
  candidates <- findCandidates(MS1, dbs[["pidb"]], ppm_precursor, rt, adducts,
                               rttol, dbs)
